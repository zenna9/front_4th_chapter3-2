...
export function getRepeatDates({ type, interval, endDate }: RepeatInfo, startDate: Date) {
  const repeatDates = [startDate.toISOString().split('T')[0]];
  ...
  // while (stillContinue) {
  //   if (type === 'daily') {
  //     nextDate.setDate(currentDate.getDate() + interval * count);
  //   } else if (type === 'weekly') {
  //     nextDate.setDate(currentDate.getDate() + interval * 7 * count);
  //   } else if (type === 'monthly') {
  //     nextDate.setMonth(currentDate.getMonth() + interval * count);
  //   } else if (type === 'yearly') {
  //     nextDate.setFullYear(currentDate.getFullYear() + interval * count);
  //   }
  //   if (nextDate <= deadLine) {
  //     repeatDates.push(nextDate.toISOString().split('T')[0]);
  //     count++;
